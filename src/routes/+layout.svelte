...
<header class="w-full h-16 flex flex-row items-center"
>
	...
	<div class="flex flex-row justify-center items-center ml-auto">
		...
		<a
			class="pr-1"
			href="https://github.com/coquobxttr/nora-kit" target="_blank"
		>
		...
		<!--switch button goes here-->
		<Nora.Button>D/L</Nora.Button>
	</div>
</header>
{@render children()}
